trigger CTDTM_BatchTemplateTrigger on Batch_Template__c (after delete, after insert, after undelete, 
    ...
    handler.run(Trigger.isBefore, Trigger.isAfter, Trigger.isInsert, Trigger.isUpdate, Trigger.isDelete, 
        Trigger.isUnDelete, Trigger.new, Trigger.old, Schema.Sobjecttype.Batch_Template__c, 
